...
@JsonKey(name: 'id') int? get id;@JsonKey(name: 'swapper') User? get swapper;@JsonKey(name: 'dispatch_officer') User? get dispatchOfficer;@JsonKey(name: 'rider') User? get rider;@JsonKey(name: 'number_of_batteries') bool? get numberOfBatteries;@JsonKey(name: 'pickup_time') String? get pickupTime;@JsonKey(name: 'delivery_time') String? get deliveryTime;@JsonKey(name: 'status') String? get status;@JsonKey(name: 'comment') String? get comment;@JsonKey(name: 'destination') AppLocation? get destination;@JsonKey(name: 'created_at') String? get createdAt;@JsonKey(name: 'updated_at') String? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,swapper,dispatchOfficer,rider,numberOfBatteries,pickupTime,deliveryTime,status,comment,destination,createdAt,updatedAt);

@override
String toString() {
  return 'BatteryRequest(id: $id, swapper: $swapper, dispatchOfficer: $dispatchOfficer, rider: $rider, numberOfBatteries: $numberOfBatteries, pickupTime: $pickupTime, deliveryTime: $deliveryTime, status: $status, comment: $comment, destination: $destination, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id') int? id,@JsonKey(name: 'swapper') User? swapper,@JsonKey(name: 'dispatch_officer') User? dispatchOfficer,@JsonKey(name: 'rider') User? rider,@JsonKey(name: 'number_of_batteries') bool? numberOfBatteries,@JsonKey(name: 'pickup_time') String? pickupTime,@JsonKey(name: 'delivery_time') String? deliveryTime,@JsonKey(name: 'status') String? status,@JsonKey(name: 'comment') String? comment,@JsonKey(name: 'destination') AppLocation? destination,@JsonKey(name: 'created_at') String? createdAt,@JsonKey(name: 'updated_at') String? updatedAt
});
...
as bool?,pickupTime: freezed == pickupTime ? _self.pickupTime : pickupTime // ignore: cast_nullable_to_non_nullable
...
as AppLocation?,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _BatteryRequest() when $default != null:
return $default(_that.id,_that.swapper,_that.dispatchOfficer,_that.rider,_that.numberOfBatteries,_that.pickupTime,_that.deliveryTime,_that.status,_that.comment,_that.destination,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@override@JsonKey(name: 'number_of_batteries') final  bool? numberOfBatteries;
